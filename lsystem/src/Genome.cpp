...
double Genome::getPenaltyFitness()
{
  return this->penalty_fitness;
}

double Genome::getNoveltyLocomotionFitness()
{
  return this->novelty_locomotion_fitness;
}
...
void Genome::updatePenaltyFitness(double fitness)
{
  this->penalty_fitness = fitness;
}

void Genome::updateNoveltyLocomotionFitness(double fitness)
{
  this->novelty_locomotion_fitness = fitness;
}
